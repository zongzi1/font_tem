...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "fixed md:relative z-40 h-screen bg-white transition-transform duration-300 ease-in-out flex flex-col",
      ...
      >
        <div className="p-6">
          ...
          >
            ...
            <span className="font-black text-xl text-blue-600 tracking-tight">Growth OS</span>
          </Link>
        </div>
